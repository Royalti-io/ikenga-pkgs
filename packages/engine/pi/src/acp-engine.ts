/**
 * ACP-shaped Pi coding agent engine adapter.
 *
 * Provides the modern AcpEngine implementation for the Pi CLI (`pi`).
...
export class PiAcpEngine implements AcpEngine {
