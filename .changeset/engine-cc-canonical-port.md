---
"@ikenga/pkg-engine-claude-code": minor
---

Port 5 commits of engine adapter evolution from the now-archived `Royalti-io/ikenga-pkg-engine-claude-code` standalone clone, which had diverged after the original subtree-add at `6a53f810`.
